...
Node::Node(int loc, MapLoader::valid_actions_t action, double g_val, double h_val, Node* parent, int timestep, int num_internal_conf, bool in_openlist, int num_non_hwy_edges, MapLoader::orientation_t orientation):
    loc(loc),  action(action), g_val(g_val), h_val(h_val), parent(parent), timestep(timestep),
