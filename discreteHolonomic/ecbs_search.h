...
class ECBSSearch {
 public:
  ...
  ECBSSearch(const MapLoader& ml, const AgentsLoader& al, const EgraphReader& egr, double e_w, double e_f, bool tweak_g_val = false);
  ...
  void printPaths(const MapLoader& ml);
