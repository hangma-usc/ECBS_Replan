...
public:
  ...
  typedef dense_hash_map<VertexProperties*, Graph_Vertex_t, CSPNodeHasher, csp_eqnode> hashtable_t;
  ...
  hashtable_t cspNodes;  // map VertexProperties to their Vertex_Descriptor

  typedef pair<Graph_Edge_t, Graph_Edge_t> edge_pair;
  vector<edge_pair> edgePairs;
  ...
  ~CreateCSP();
  //  void exportcsp(string filename);
